 ...
 */
public class LeixingItemAdapter extends BaseAdapter{

    private List<LeixingItemData.DataEntity.ReturnDataEntity> lists;
    private LayoutInflater lif;
    private Context context;

    public LeixingItemAdapter(Context context,List<LeixingItemData.DataEntity.ReturnDataEntity> lists) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            vh = new ViewHolder();
            convertView = lif.inflate(R.layout.lvitem_leixing_item,null);
            vh.iv_pic = (ImageView) convertView.findViewById(R.id.iv_leixing_item_item_pic);
            vh.tv_name = (TextView) convertView.findViewById(R.id.tv_leixing_item_item_name);
            vh.tv_aut = (TextView) convertView.findViewById(R.id.leixing_item_item_aut);
            vh.tv_num = (TextView) convertView.findViewById(R.id.leixing_item_item_num);
            vh.tv_type = (TextView) convertView.findViewById(R.id.leixing_item_item_type);
            vh.tv_value = (TextView) convertView.findViewById(R.id.leixing_item_item_value);
